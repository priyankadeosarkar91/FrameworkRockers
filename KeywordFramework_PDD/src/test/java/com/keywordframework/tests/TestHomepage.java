...
public class TestHomepage {
	...
	@Test(description = "VerifyWindowHandle : perform action on new window")
	public void tc_011() {
			log.info("******************* Verify Window Handle **********************");
		Keyword.clickOnElement("XPATH", "//a[@href='/info/redcare']");
...
//	
	...
	public void tc_020() {
		...
		Keyword.takeAScreenshot("tc_020");
	}
	...
	public void tc_021() {
		...
		Keyword.takeFullpagescreenshot("tc_020");
