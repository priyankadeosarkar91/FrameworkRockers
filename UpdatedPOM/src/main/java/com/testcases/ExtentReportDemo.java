...
public class ExtentReportDemo 
{
	...
	{    
	  ...
	  /* logger.log(Status.INFO, "Login to amazon");
	    logger.log(Status.INFO,"HomePage  Verification");
	    logger.log(Status.INFO, "Return to homepage");
	    logger.log(Status.INFO,"Check Customer ServiceDetails");
	    logger.log(Status.INFO,"Amazon Pay Details");
	    logger.log(Status.INFO,"Birthday Card successfully selected");
